                        ...
                        <?php echo Form::open(['route' => 'setting.generalStore', 'files' => true, 'method' => 'post']); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="vat_number" value="<?php echo e($lims_general_setting_data->vat_number); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><?php echo e(trans('file.Email')); ?> *</label>
                                    <input type="email" name="email" value="<?php echo e($lims_general_setting_data->email); ?>" required class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><?php echo e(trans('file.Phone Number')); ?> *</label>
                                    <input type="text" name="phone_number" value="<?php echo e($lims_general_setting_data->phone_number); ?>" required class="form-control">
                                </div>
                            </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/hotech/resources/views/setting/general_setting.blade.php ENDPATH**/ ?>