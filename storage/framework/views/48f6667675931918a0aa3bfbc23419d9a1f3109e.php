...
<html>
  ...
  <body onload="myFunction()">
        ...
        <div class="side-navbar-wrapper">
          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              ?>
              <?php if($sale_index_permission_active || $delivery_permission_active): ?>
             ...
             //           ['permission_id', $resume->id],
              ...
              <li class=""><a href="#hrm" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-user-group"></i><span><?php echo e(trans('file.HRM')); ?></span></a>
                <ul id="hrm" class="hidden list-unstyled ">
                  ...
                  <li id="activity-menu"><a href="<?php echo e(route('activity.index')); ?>"><?php echo e(trans('file.Activity')); ?></a></li>
                  <?php endif; ?>
                  <?php if($resume_active): ?>
                  <li id="resume-menu"><a href="<?php echo e(route('resume.index')); ?>"><?php echo e(trans('file.Resume')); ?></a></li>
                  <?php endif; ?>
                </ul>
              </li>
              <?php endif; ?>
                ...
                <div class="modal-body">
                  <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                    <?php echo Form::open(['route' => 'notifications.store', 'method' => 'post']); ?>
                      ...
                      <div class="mb-4">
                          <button type="submit" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-blue-600 text-white hover:bg-blue-600"><?php echo e(trans('file.submit')); ?></button>
                      </div>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('file.Add Activity')); ?></h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="absolute top-0 bottom-0 right-0 px-4 py-3"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
              <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                <?php echo Form::open(['route' => 'activity.store', 'method' => 'post', 'files' => true]); ?>
                ...
                <div class="flex flex-wrap ">
                    ...
                    <div class="md:w-1/2 pr-4 pl-4 mb-4">
                        ...
                        <input type="text" name="date" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded date" value="<?php echo e(date($general_setting->date_format)); ?>" required>
                    </div>
                    <div class="md:w-1/2 pr-4 pl-4 mb-4">
                        <label><?php echo e(trans('file.Hour')); ?> *</label>
                    ...
                    <div class="md:w-1/2 pr-4 pl-4 mb-4">
                        <label><?php echo e(trans('file.Object')); ?> *</label>
                    ...
                    <div class="md:w-1/2 pr-4 pl-4 mb-4">
                        <label><?php echo e(trans('file.Duration')); ?> *</label>
                    ...
                    <div class="md:w-1/2 pr-4 pl-4 mb-4">
                        <label><?php echo e(trans('file.Transportation')); ?> *</label>
                    ...
                    <div class="md:w-1/2 pr-4 pl-4 mb-4">
                        <label><?php echo e(trans('file.Expense')); ?> *</label>
                    ...
                    <div class="md:w-1/2 pr-4 pl-4 mb-4">
                        <label><?php echo e(trans('file.Place')); ?> *</label>
        ...
        <div class="container mx-auto sm:px-4 max-w-full mx-auto sm:px-4">
          <div class="flex flex-wrap ">
            <div class="sm:w-full pr-4 pl-4">
              <p>&copy; <?php echo e($general_setting->site_title); ?> | <?php echo e(trans('file.Developed')); ?> <?php echo e(trans('file.By')); ?> <span class="external">Zakaria Labib</span></p>
            </div>
          </div>
        </div>
      </footer>
...
</html><?php /**PATH /Applications/MAMP/htdocs/hotech/resources/views/layout/main.blade.php ENDPATH**/ ?>