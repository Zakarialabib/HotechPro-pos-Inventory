...
class SettingController extends Controller
{
    ...
    public function generalSettingStore(Request $request)
    {
        ...
        $general_setting->vat_number = $data['vat_number'];
        $general_setting->email = $data['email'];
        $general_setting->phone_number = $data['phone_number'];
        ...
        return redirect()->back()->with('message', 'Données à jour et enregistrées avec succès');
    }
