...
class SaleController extends Controller
{
    ...
    public function genInvoice($id)
    {
        ...
        return view('sale.invoice', compact('lims_sale_data', 'lims_product_sale_data', 'lims_general_setting_data', 'lims_biller_data', 'lims_warehouse_data', 'lims_customer_data', 'lims_payment_data', 'numberInWords'));
    }
