...
Route::group(['middleware' => ['auth', 'active']], function() {
	...
	Route::get('quotations/gen_invoice/{id}', 'QuotationController@genInvoice')->name('quotation.invoice');
	...
	Route::get('resume/show-{id}', 'ActivityController@show')->name('interventions.show');


	Route::post('activity/deletebyselection', 'ActivityController@deleteBySelection');
	Route::get('activity/show-{id}', 'ActivityController@show')->name('interventions.show');
