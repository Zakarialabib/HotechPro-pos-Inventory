    ...
    <div class="flex flex-wrap px-3 mx-auto">
      <div class="w-full mt-2">
          ...
          <div class="float-right">
              <a href="#" data-toggle="modal" data-target="#createModal" class="align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-blue-600 text-white hover:bg-blue-600"><i class="dripicons-plus"></i> {{trans('file.Add Warehouse')}}</a>
              <a href="#" data-toggle="modal" data-target="#importWarehouse" class="align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-blue-600 text-white hover:bg-blue-600"><i class="dripicons-copy"></i> {{trans('file.Import Warehouse')}}</a>
            </div>
      </div>
    </div>
