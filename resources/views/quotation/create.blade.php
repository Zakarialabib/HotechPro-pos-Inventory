                            ...
                            <div class="md:w-full pr-4 pl-4">
                                <div class="flex flex-wrap ">
                                    ...
                                    <div class="md:w-1/3 pr-4 pl-4">
                                        <div class="mb-4">
                                            ...
                                            <select id="customer_id" name="customer_id" required class="selectpicker block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" data-live-search="true" id="customer-id" data-live-search-style="begins" title="Select customer...">
                                    ...
                                    <div class="md:w-1/3 pr-4 pl-4">
                                        <div class="mb-4">
                                            ...
                                            <select id="warehouse_id" name="warehouse_id" required class="selectpicker block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" data-live-search="true" data-live-search-style="begins" title="Select warehouse...">
                                ...
                                <div class="flex flex-wrap ">
                                	<div class="md:w-1/3 pr-4 pl-4">
                                		<div class="mb-4">
                                			...
                                			<select class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" name="quotation_status">
                                ...
                                <div class="flex flex-wrap ">
                                	<div class="md:w-full pr-4 pl-4">
                                		<div class="mb-4">
                                			<label>Details</label>
                                			<textarea rows="5" name="note" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded"></textarea>
                                		</div>
                                	</div>
                                </div>
                                <div class="mb-4">
