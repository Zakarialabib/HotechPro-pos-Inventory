                                ...
                                <div class="flex flex-wrap ">
                                	...
                                	<div class="md:w-1/4 pr-4 pl-4">
                                        <div class="mb-4">
                                            ...
                                            <select required id="customer_id" name="customer_id" class="selectpicker block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" data-live-search="true" id="customer-id" data-live-search-style="begins" title="Select customer...">
                                ...
                                <div class="flex flex-wrap ">
                                    ...
                                    <div class="md:w-1/3 pr-4 pl-4">
                                        <div class="mb-4">
                                            ...
                                            <select name="quotation_status" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded">
