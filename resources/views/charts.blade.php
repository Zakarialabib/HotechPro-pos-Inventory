      ...
      <div class="breadcrumb-holder">
        <div class="mx-auto px-2 max-w-full mx-auto">
          <ul class="flex flex-wrap list-reset pt-3 pb-3 py-4 px-4 mb-4 bg-gray-200 rounded">
            ...
            <li class="inline-block px-2 py-2 text-gray-700 active">Charts       </li>
          </ul>
        </div>
      </div>
      <section class="charts">
        <div class="mx-auto px-2 max-w-full mx-auto">
          ...
          <div class="flex flex-wrap ">
            ...
            <div class="md:w-1/2 pr-4 pl-4">
              <div class="relative flex flex-col min-w-0 rounded break-words border bg-white border-1 border-gray-300 bar-chart-example">
                <div class="py-3 px-6 mb-0 bg-gray-200 border-b-1 border-gray-300 text-gray-900 flex items-center">
            ...
            <div class="md:w-1/2 pr-4 pl-4">
              <div class="relative flex flex-col min-w-0 rounded break-words border bg-white border-1 border-gray-300 pie-chart-example">
                <div class="py-3 px-6 mb-0 bg-gray-200 border-b-1 border-gray-300 text-gray-900 flex items-center">
            ...
            <div class="md:w-1/2 pr-4 pl-4">
              <div class="relative flex flex-col min-w-0 rounded break-words border bg-white border-1 border-gray-300 polar-chart-example">
                <div class="py-3 px-6 mb-0 bg-gray-200 border-b-1 border-gray-300 text-gray-900 flex items-center">
            ...
            <div class="md:w-full pr-4 pl-4">
              <div class="relative flex flex-col min-w-0 rounded break-words border bg-white border-1 border-gray-300 radar-chart-example">
                <div class="py-3 px-6 mb-0 bg-gray-200 border-b-1 border-gray-300 text-gray-900 flex items-center">
