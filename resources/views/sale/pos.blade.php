        ...
        <div class="flex flex-wrap ">
            ...
            <div class="md:w-1/2 pr-4 pl-4">
                <div class="relative flex flex-col min-w-0 rounded break-words border bg-white border-1 border-gray-300">
                    <div class="flex-auto p-6" style="padding-bottom: 0">
                            ...
                            <div class="md:w-full pr-4 pl-4">
                                <div class="flex flex-wrap ">
                                    <div class="md:w-1/3 pr-4 pl-4">
                                      <div class="mb-4">
                                          <input type="text" name="reference_no" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" placeholder="Type reference number" />
                                      </div>
                                    </div>
                                    <div class="md:w-1/3 pr-4 pl-4">
                                        <div class="mb-4">
                                    ...
                                    <div class="md:w-1/3 pr-4 pl-4">
                                        <div class="mb-4">
                                            ...
                                            <div class="relative flex items-stretch w-full pos">
                                                @if($customer_active)
                                                <select required name="customer_id" id="customer_id" class="selectpicker block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" data-live-search="true" data-live-search-style="begins" title="Select customer..." style="width: 100px">
                                                <?php $deposit = [] ?>
                                    ...
                                    <div class="md:w-full pr-4 pl-4">
                                        <div class="search-box mb-4">
                                            <input type="text" name="product_code_name" id="lims_productcodeSearch" placeholder="Scan/Search product by name/code" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded"  />
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-4">
                                    <div class="block w-full overflow-auto scrolling-touch transaction-list">
                                        <table id="myTable" class="w-full max-w-full mb-4 bg-transparent table-hover table-striped order-list table-fixed">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="sm:w-1/4 pr-4 pl-4">{{trans('file.Subtotal')}}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            </tbody>
                    ...
                    <div class="payment-options">
                        ...
                        <div class="column-5">
                            <button style="background-color: #ffc107;" type="button" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline btn-custom" data-toggle="modal" data-target="#recentTransaction"><i class="dripicons-clock"></i> Recent transaction</button>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="md:w-4/5 pr-4 pl-4">
                                    <div class="flex flex-wrap ">
                                        <div class="md:w-1/2 pr-4 pl-4 mt-1">
                                            ...
                                            <input type="text" name="paying_amount" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded numkey" required step="any">
                                        </div>
                                        <div class="md:w-1/2 pr-4 pl-4 mt-1">
                                        ...
                                        <div class="md:w-1/2 pr-4 pl-4 mt-1">
                                            ...
                                            <select name="paid_by_id_select" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded selectpicker">
                                        ...
                                        <div class="mb-4 md:w-full pr-4 pl-4 gift-card">
                                        ...
                                        <div class="mb-4 md:w-full pr-4 pl-4 cheque">
                                    ...
                                    <div class="mt-3">
                                        <button id="submit-btn" type="button" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-blue-600 text-white hover:bg-blue-600">{{trans('file.submit')}}</button>
                                    </div>
                                </div>
            ...
            <div id="order-discount" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal opacity-0 text-left">
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-4">
                                <input type="text" name="order_discount" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded numkey">
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-4">
                                ...
                                <select class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" name="order_tax_rate_select">
            ...
            <div id="shipping-cost-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal opacity-0 text-left">
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-4">
                                <input type="text" name="shipping_cost" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded numkey" step="any">
                            </div>
            ...
            <div class="md:w-1/2 pr-4 pl-4">
                      ...
                      <div class="container mx-auto sm:px-4 max-w-full mx-auto sm:px-4">
                        <div class="navbar-holder flex items-center justify-between">
                          ...
                          <ul class="nav-menu list-unstyled flex md:flex-row md:items-center">
                            ...
                            ?>
                            @if($pos_setting_permission_active)
                            <li class=""><a class="block w-full py-1 px-6 font-normal text-gray-900 whitespace-no-wrap border-0" href="{{route('setting.pos')}}" title="{{trans('file.POS Setting')}}"><i class="dripicons-gear"></i></a> </li>
                            @endif
                            <li class="">
    			...
    			<div class="flex flex-wrap ">
                    ...
                    <div class="md:w-full pr-4 pl-4 mt-1 table-container">
                        <table id="product-table" class="w-full max-w-full mb-4 bg-transparent no-shadow product-list">
                            <thead class="hidden">
                                <tr>
                                    <th></th>
                                    <th></th>
            ...
            <div id="recentTransaction" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal opacity-0 text-left">
                <div role="document" class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 id="exampleModalLabel" class="modal-title">{{trans('file.Recent Transaction')}} <div class="inline-block p-1 text-center font-semibold text-sm align-baseline leading-none rounded bg-blue-500 text-white hover:bg-blue-600">{{trans('file.latest')}} 10</div></h5>
                      <button type="button" data-dismiss="modal" aria-label="Close" class="absolute top-0 bottom-0 right-0 px-4 py-3"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                    </div>
                    <div class="modal-body">
                        <ul class="flex flex-wrap list-none pl-0 mb-0 border border-t-0 border-r-0 border-l-0 border-b-1 border-gray-200" role="tablist">
                          ...
                          <li class="">
                            <a class="inline-block py-2 px-4 no-underline" href="#draft-latest" role="tab" data-toggle="tab">{{trans('file.Draft')}}</a>
                          </li>
                        </ul>
                        <div class="tab-content">
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <div class="relative inline-flex align-middle">
                                            ...
                                            <a href="{{ route('sales.edit', $sale->id) }}" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded  no-underline bg-green-500 text-white hover:bg-green-600 py-1 px-2 leading-tight text-xs " title="Edit"><i class="dripicons-document-edit"></i></a>&nbsp;
                                            @endif
                                            @if(in_array("sales-delete", $all_permission))
                                            {{ Form::open(['route' => ['sales.destroy', $sale->id], 'method' => 'DELETE'] ) }}
                                            <button type="submit" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded  no-underline bg-red-600 text-white hover:bg-red-700 py-1 px-2 leading-tight text-xs " onclick="return confirmDelete()" title="Delete"><i class="dripicons-trash"></i></button>
                                            {{ Form::close() }}
                                            @endif
                                        </div>
                                      </td>
                          ...
                          <div role="tabpanel" class="tab-pane opacity-0" id="draft-latest">
                              <div class="block w-full overflow-auto scrolling-touch">
                                <table class="w-full max-w-full mb-4 bg-transparent">
                                  <thead>
                                    <tr>
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <div class="relative inline-flex align-middle">
                                            @if(in_array("sales-edit", $all_permission))
                                            <a href="{{url('sales/'.$draft->id.'/create') }}" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded  no-underline bg-green-500 text-white hover:bg-green-600 py-1 px-2 leading-tight text-xs " title="Edit"><i class="dripicons-document-edit"></i></a>&nbsp;
                                            @endif
                                            @if(in_array("sales-delete", $all_permission))
            ...
            <div id="cash-register-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal opacity-0 text-left">
                <div role="document" class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                        <div class="flex flex-wrap ">
                          <div class="md:w-1/2 pr-4 pl-4 mb-4 warehouse-section">
                          ...
                          <div class="md:w-1/2 pr-4 pl-4 mb-4">
                              ...
                              <input type="number" name="cash_in_hand" required class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded">
                          </div>
                        ...
                        <div class="flex flex-wrap ">
                            ...
                            <div class="md:w-1/2 pr-4 pl-4" id="closing-section">
                              <form action="{{route('cashRegister.close')}}" method="POST">
                                  ...
                                  <button type="submit" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-blue-600 text-white hover:bg-blue-600">{{trans('file.Close Register')}}</button>
                              </form>
                            </div>
                        </div>
                    </div>
            ...
            <!-- today sale modal -->
            <div id="today-sale-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal opacity-0 text-left">
                <div role="document" class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
            ...
            <!-- today profit modal -->
            <div id="today-profit-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal opacity-0 text-left">
                <div role="document" class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="flex flex-wrap ">
                            <div class="md:w-1/2 pr-4 pl-4">
                                <select required name="warehouseId" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded">
                            ...
                            <div class="md:w-full pr-4 pl-4 mt-2">
                                <table class="w-full max-w-full mb-4 bg-transparent table-hover">
                                    <tbody>
                                        <tr>
...
function populateProduct(data) {
    var tableData = '<table id="product-table" class="w-full max-w-full mb-4 bg-transparent no-shadow product-list"> <thead class="hidden"> <tr> <th></th> <th></th> <th></th> <th></th> <th></th> </tr></thead> <tbody><tr>';
...
function addNewProduct(data){
    ...
    cols += '<td class="sm:w-1/3 pr-4 pl-4 product-title"><button type="button" class="edit-product inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline font-normal text-blue-700 bg-transparent" data-toggle="modal" data-target="#editModal"><strong>' + data[0] + '</strong></button> [' + data[1] + '] <p>In Stock: <span class="in-stock"></span></p></td>';
    ...
    cols += '<td class="sm:w-1/6 pr-4 pl-4"><button type="button" class="ibtnDel inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded  no-underline bg-red-600 text-white hover:bg-red-700 py-1 px-2 leading-tight text-xs "><i class="dripicons-cross"></i></button></td>';
