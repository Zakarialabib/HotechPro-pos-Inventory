                    ...
                    @if (in_array('products-add', $all_permission))
                        <div class="float-right">
                            <a href="{{ route('products.create') }}"
                                class="align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-blue-600 text-white hover:bg-blue-600"><i
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <a href="public/sample_file/sample_products.csv"
                                    class="align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-blue-600 text-white hover:bg-blue-600 btn-block btn-md"><i
