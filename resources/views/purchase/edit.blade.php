                                            ...
                                            <table id="myTable" class="w-full max-w-full mb-4 bg-transparent table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td><input type="number" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded qty" name="qty[]" value="{{$product_purchase->qty}}" step="any" required /></td>
                                                        <td class="recieved-product-qty hidden"><input type="number" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded recieved" name="recieved[]" value="{{$product_purchase->recieved}}" step="any"/></td>
                                ...
                                <div class="flex flex-wrap  mt-5">
                                    ...
                                    <div class="md:w-1/3 pr-4 pl-4">
                                        <div class="mb-4">
                                            ...
                                            <input type="number" name="order_discount" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" value="{{$lims_purchase_data->order_discount}}" step="any" />
                                        </div>
                                    </div>
                                    <div class="md:w-1/3 pr-4 pl-4">
                                        <div class="mb-4">
                                            ...
                                            <input type="number" name="shipping_cost" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" value="{{$lims_purchase_data->shipping_cost}}" step="any" />
                                        </div>
                                    </div>
                                </div>
                                <div class="flex flex-wrap ">
                                    <div class="md:w-full pr-4 pl-4">
                                        <div class="mb-4">
                                            ...
                                            <textarea rows="5" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" name="note" >{{ $lims_purchase_data->note }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-4">
