                                ...
                                <div class="flex flex-wrap ">
                                    ...
                                    <div class="md:w-1/3 pr-4 pl-4">
                                        <div class="mb-4">
                                            ...
                                            <select required id="account_id" name="account_id" class="selectpicker block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" data-live-search="true" data-live-search-style="begins" title="Select account...">
                                            ...
                                            <table id="myTable" class="w-full max-w-full mb-4 bg-transparent table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td><input type="number" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded qty" name="qty[]" value="{{$product_return->qty}}" required step="any" /></td>
                                ...
                                <div class="flex flex-wrap ">
                                    <div class="md:w-1/2 pr-4 pl-4">
                                        <div class="mb-4">
                                            ...
                                            <textarea rows="5" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" name="return_note">{{$lims_return_data->return_note}}</textarea>
                                        </div>
                                    </div>
                                    <div class="md:w-1/2 pr-4 pl-4">
                                        <div class="mb-4">
                                            <label>{{trans('file.Staff Note')}}</label>
                                            <textarea rows="5" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded" name="staff_note">{{$lims_return_data->staff_note}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-4">
