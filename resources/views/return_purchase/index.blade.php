    ...
    <div class="flex flex-wrap px-3 mx-auto">
        <div class="w-full mt-2">
            ...
            <div class="float-right">
                <a href="{{route('return-purchase.create')}}" class="align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-blue-600 text-white hover:bg-blue-600"><i class="dripicons-plus"></i> {{trans('file.Add Return')}}</a>
            </div>
            @endif
        </div>
      </div>
